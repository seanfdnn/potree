...
export class PropertiesPanel{
	...
	setPointCloud(pointcloud){
		...
		{
			const schemes = Object.keys(exports.Gradients).map(name => ({name: name, values: Gradients[name]}));
			...
			for(let scheme of schemes){
				...
				const svg = exports.Utils.createSvgGradient(scheme.values);
		...
		{
			let matcaps = [
				{name: "Normals", icon: `${exports.resourcePath}/icons/matcap/check_normal+y.jpg`}, 
				{name: "Basic 1", icon: `${exports.resourcePath}/icons/matcap/basic_1.jpg`}, 
				{name: "Basic 2", icon: `${exports.resourcePath}/icons/matcap/basic_2.jpg`}, 
				{name: "Basic Dark", icon: `${exports.resourcePath}/icons/matcap/basic_dark.jpg`}, 
				{name: "Basic Side", icon: `${exports.resourcePath}/icons/matcap/basic_side.jpg`}, 
				{name: "Ceramic Dark", icon: `${exports.resourcePath}/icons/matcap/ceramic_dark.jpg`}, 
				{name: "Ceramic Lightbulb", icon: `${exports.resourcePath}/icons/matcap/ceramic_lightbulb.jpg`}, 
				{name: "Clay Brown", icon: `${exports.resourcePath}/icons/matcap/clay_brown.jpg`}, 
				{name: "Clay Muddy", icon: `${exports.resourcePath}/icons/matcap/clay_muddy.jpg`}, 
				{name: "Clay Studio", icon: `${exports.resourcePath}/icons/matcap/clay_studio.jpg`}, 
				{name: "Resin", icon: `${exports.resourcePath}/icons/matcap/resin.jpg`}, 
				{name: "Skin", icon: `${exports.resourcePath}/icons/matcap/skin.jpg`}, 
				{name: "Jade", icon: `${exports.resourcePath}/icons/matcap/jade.jpg`}, 
				{name: "Metal_ Anisotropic", icon: `${exports.resourcePath}/icons/matcap/metal_anisotropic.jpg`}, 
				{name: "Metal Carpaint", icon: `${exports.resourcePath}/icons/matcap/metal_carpaint.jpg`}, 
				{name: "Metal Lead", icon: `${exports.resourcePath}/icons/matcap/metal_lead.jpg`}, 
				{name: "Metal Shiny", icon: `${exports.resourcePath}/icons/matcap/metal_shiny.jpg`}, 
				{name: "Pearl", icon: `${exports.resourcePath}/icons/matcap/pearl.jpg`}, 
				{name: "Toon", icon: `${exports.resourcePath}/icons/matcap/toon.jpg`},
				{name: "Check Rim Light", icon: `${exports.resourcePath}/icons/matcap/check_rim_light.jpg`}, 
				{name: "Check Rim Dark", icon: `${exports.resourcePath}/icons/matcap/check_rim_dark.jpg`}, 
				{name: "Contours 1", icon: `${exports.resourcePath}/icons/matcap/contours_1.jpg`}, 
				{name: "Contours 2", icon: `${exports.resourcePath}/icons/matcap/contours_2.jpg`}, 
				{name: "Contours 3", icon: `${exports.resourcePath}/icons/matcap/contours_3.jpg`}, 
				{name: "Reflection Check Horizontal", icon: `${exports.resourcePath}/icons/matcap/reflection_check_horizontal.jpg`}, 
				{name: "Reflection Check Vertical", icon: `${exports.resourcePath}/icons/matcap/reflection_check_vertical.jpg`}, 
			];
